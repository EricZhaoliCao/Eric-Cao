    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-white/20">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-white/5">
        <div className="container flex items-center justify-between h-16">
          ...
          <Button variant="outline" size="sm" className="gap-2 hidden sm:flex" onClick={() => window.open('/resume.pdf', '_blank')}>
                ...
                <div className="shrink-0">
                  <Dialog>
                    ...
                    <DialogContent className="max-w-3xl bg-background/95 border-white/10">
                      <DialogTitle className="text-xl font-semibold">Academic Transcript</DialogTitle>
                      <DialogDescription>Official transcript snapshot demonstrating academic performance.</DialogDescription>
                      <div className="mt-4">
                        <img 
                          src="/images/gpa-transcript.jpg" 
                          alt="HKU Transcript GPA 4.0" 
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Card key={index} className="bg-transparent border border-white/10 hover:border-white/30 transition-colors rounded-none overflow-hidden group">
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  "HKU Master of Finance Transcript",
                  "Fudan University Transcript",
                  "WorldQuant Challenge Gold Medal Certificate",
                  "IMC Prosperity3 Top 2% Certificate"
                ].map((item, i) => (
                  <div key={i} className="flex items-center justify-between p-4 border border-white/10 hover:border-white/30 transition-colors">
